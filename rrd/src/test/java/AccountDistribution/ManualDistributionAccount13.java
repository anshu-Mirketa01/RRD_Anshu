package AccountDistribution;
	...
	public class ManualDistributionAccount13 {
		...
		public void setUp() throws FileNotFoundException, InterruptedException {
			report = new ExtentReports("./Report/AccountDistribution13.html");
			logger = report.startTest("Verify Account Distribution13");
		...
		@Test
		public void AccountManualDistribution13() throws InterruptedException {
			...
			for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
				...
				String Assigneduser = reader.getCellData("AccountAllocation13", "ExpectedResultAfterDistribution", rowNum);
				String Teamname = reader.getCellData("AccountAllocation13", "TeamName", rowNum);
				String ToBecount = reader.getCellData("AccountAllocation13", "ToBeAssignedAfterdistribution", rowNum);
