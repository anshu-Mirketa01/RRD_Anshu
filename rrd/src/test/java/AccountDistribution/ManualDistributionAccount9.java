...
public class ManualDistributionAccount9 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/AccountDistribution9.html");
		logger = report.startTest("Verify Account Distribution17");
	...
	@Test
	public void AccountManualDistribution9() throws InterruptedException {
		...
		/*
		 * reader.removeColumn("CaseAllocation_config17", 20); Thread.sleep(3000);
		 */
