...
import org.openqa.selenium.WebDriver;
	...
	public class ManualDistributionAccount12 {
		...
		public void setUp() throws FileNotFoundException, InterruptedException {
			report = new ExtentReports("./Report/AccountDistribution12.html");
			logger = report.startTest("Verify Account Distribution12");
		...
		@Test
		public void AccountManualDistribution12() throws InterruptedException {
			...
			for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
				...
				String Assigneduser = reader.getCellData("AccountAllocation12", "ExpectedResultAfterDistribution", rowNum);
				String Teamname = reader.getCellData("AccountAllocation12", "TeamName", rowNum);
				String ToBecount = reader.getCellData("AccountAllocation12", "ToBeAssignedAfterdistribution", rowNum);
