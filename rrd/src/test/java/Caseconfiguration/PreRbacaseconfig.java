package Caseconfiguration;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate- Pre RBA Case Config</b>
	 * </p>
	 * <p>
	...
	public class PreRbacaseconfig {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/PreRBAcaseconfig.html");
				logger = report.startTest("Verify PreRBAcaseconfig");
			...
			@Test
			public void PreRBAcaseconfig() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("PreRBAcaseConfig");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("PreRBAcaseConfig", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("PreRBAcaseConfig", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("PreRBAcaseConfig", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("PreRBAcaseConfig", "casepriority", rowNum);
