package Caseconfiguration;
	 ...
	 * <p>.Enter the case priority as Medium.</p>
	 * 
	 ...
	 */
		...
		public class CaseConfig7 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration7.html");
				logger = report.startTest("Verify Case Configuration7");
			...
			public void TestCaseConfig5() throws InterruptedException{
				...
				int rowCount = reader.getRowCount("Caseconfig7");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig7", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig7", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig7", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig7", "casepriority", rowNum);
				...
				logger.log(LogStatus.INFO, "Entered case Priority as Medium");
