package Caseconfiguration;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Case Configuration 12</b>
	 * </p>
	 * <p>
	 ...
	 */
		...
		public class CaseConfig12 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration12.html");
				logger = report.startTest("Verify Case Configuration12");
			...
			@Test
			public void TestCaseConfig12() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig12");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig12", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig12", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig12", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig12", "casepriority", rowNum);
