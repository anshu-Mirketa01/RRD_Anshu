...
/**
 * <p>
 * <b>QAT-RRD-Automate Case Configuration 1</b>
 * </p>
 * <p>
 ...
 * <p>6.Select user from drop down value that is None.</p>
 ...
 */
	...
	public class CaseConfig1 {
		...
		public void setUp() throws FileNotFoundException, InterruptedException {
			report = new ExtentReports("./Report/CaseConfiguration1.html");
			logger = report.startTest("Verify Case Configuration1");
		...
		@Test
		public void TestCaseConfig1() throws InterruptedException{

			Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
			
			int rowCount = reader.getRowCount("Caseconfig1");
			for (int rowNum = 2; rowNum <= rowCount; rowNum++)
			{
			
			String sUser1=reader.getCellData("Caseconfig1", "Enable_RRD_Users" , rowNum);
			String sOwnerNotification=reader.getCellData("Caseconfig1", "ownerNotification", rowNum);
			String sReleationshipBasedAssignment=reader.getCellData("Caseconfig1", "Rel_Based_Asgmt", rowNum);
			String sCasePriority=reader.getCellData("Caseconfig1", "casepriority", rowNum);
