	 ...
	 */
		...
		public class CaseConfig5 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration5.html");
				logger = report.startTest("Verify Case Configuration5");
			...
			public void TestCaseConfig5() throws InterruptedException{
				...
				int rowCount = reader.getRowCount("Caseconfig5");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig5", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig5", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig5", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig5", "casepriority", rowNum);
