package Caseconfiguration;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Case Configuration 16</b>
	 * </p>
	 * <p>
	 ...
	 */
		...
		public class CaseConfig16 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration16.html");
				logger = report.startTest("Verify Case Configuration16");
			...
			@Test
			public void TestCaseConfig16() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig16");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig16", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig16", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig16", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig16", "casepriority", rowNum);
