package Caseconfiguration;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Case Configuration 17</b>
	 * </p>
	 * <p>
	 ...
	 * <p>6.Select user from drop down value that is All.</p>
	 * <p>7.Select owner notification from drop down value that is Both .</p>
	 * <p>8.Select Relationship based assignment value from drop down that is None.</p>
	 * <p>9.Check Queue assignment checkbox</p>
	 * <p>10.Check handle manual assignment checkbox</p>
	 * <p>11.Check Handle High Priority Case Checkbox</p>
	 * 
	 * 
	 ...
	 */
		...
		public class CaseConfig17 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration17.html");
				logger = report.startTest("Verify Case Configuration17");
			...
			@Test
			public void TestCaseConfig17() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig17");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig17", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig17", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig17", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig17", "casepriority", rowNum);
				...
				logger.log(LogStatus.INFO, "Select owner notification from drop down value that is Both");
				...
				step1ConfigPage.clickOnCheckQueueAssignmentCheckbox();
				logger.log(LogStatus.INFO, "Check Queue assignment checkbox");
			
				
				step1ConfigPage.unCheckHandleManualAssignmentCheckbox();
				logger.log(LogStatus.INFO, "Uncheck handle manual assignment checkbox");
				
				step1ConfigPage.clickOnHandleManualAssignmentCheckbox();
				logger.log(LogStatus.INFO, "Check handle manual assignment checkbox");
				...
				step1ConfigPage.clickOnHandleHighPriorityCaseCheckbox();
				logger.log(LogStatus.INFO, "Check Handle High Priority Case Checkbox");
				
				step1ConfigPage.ClearCasePriority();
				logger.log(LogStatus.INFO, "clear case Priority");
