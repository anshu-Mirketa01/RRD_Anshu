package Caseconfiguration;
	 ...
	 * <p>7.Select owner notification from drop down value that is Notify by Task .</p>
	 ...
	 */
		...
		public class CaseConfig13 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration13.html");
				logger = report.startTest("Verify Case Configuration13");
			...
			@Test
			public void TestCaseConfig13() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig13");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig13", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig13", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig13", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig13", "casepriority", rowNum);
				...
				logger.log(LogStatus.INFO, "Select owner notification from drop down value that is Notify by Task");
