package Caseconfiguration;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Case Configuration 14</b>
	 * </p>
	 * <p>
	 ...
	 */
		...
		public class CaseConfig14 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration14.html");
				logger = report.startTest("Verify Case Configuration14");
			...
			@Test
			public void TestCaseConfig14() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig14");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig14", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig14", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig14", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig14", "casepriority", rowNum);
