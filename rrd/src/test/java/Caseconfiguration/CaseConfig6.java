package Caseconfiguration;
	 ...
	 * <p>.Enter the case priority as Low.</p>
	 * 
	 ...
	 */
		...
		public class CaseConfig6 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration6.html");
				logger = report.startTest("Verify Case Configuration6");
			...
			public void TestCaseConfig5() throws InterruptedException{
				...
				int rowCount = reader.getRowCount("Caseconfig6");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig6", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig6", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig6", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig6", "casepriority", rowNum);
				...
				logger.log(LogStatus.INFO, "Entered case Priority as Low");
