package Caseconfiguration;
	 ...
	 * <p>10.Check Hthandle manual assignment checkbox</p>
	 ...
	 */
		...
		public class CaseConfig10 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration10.html");
				logger = report.startTest("Verify Case Configuration10");
			...
			public void TestCaseConfig5() throws InterruptedException{
				...
				int rowCount = reader.getRowCount("Caseconfig10");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig10", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig10", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig10", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig10", "casepriority", rowNum);
