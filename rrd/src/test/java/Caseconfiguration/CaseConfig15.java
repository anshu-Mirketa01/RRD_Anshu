package Caseconfiguration;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Case Configuration 15</b>
	 * </p>
	 * <p>
	 ...
	 * <p>7.Select owner notification from drop down value that is Notify by Email .</p>
	 ...
	 * <p>.12.Enter the Priority</p>
	 * 
	 * <p>13.click on save button to save data</p>
	 * <p>14.Assert that Case config  changes has saved By checking if Edit button is visible </p>
	 * 
	 * 
	 * 
	 * @author Anshu
	 ...
	 */
		...
		public class CaseConfig15 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration15.html");
				logger = report.startTest("Verify Case Configuration15");
			...
			@Test
			public void TestCaseConfig15() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig15");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig15", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig15", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig15", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig15", "casepriority", rowNum);
				...
				logger.log(LogStatus.INFO, "Select owner notification from drop down value that is Notify by Email");
				...
				logger.log(LogStatus.INFO, "Enter case Priority");
