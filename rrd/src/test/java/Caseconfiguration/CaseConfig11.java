package Caseconfiguration;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Case Configuration 11</b>
	 * </p>
	 * <p>
	 ...
	 */
		...
		public class CaseConfig11 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration11.html");
				logger = report.startTest("Verify Case Configuration11");
			...
			@Test
			public void TestCaseConfig11() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig11");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig11", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig11", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig11", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig11", "casepriority", rowNum);
				...
				logger.log(LogStatus.INFO, "Select owner notification from drop down value that is Notify bu Email");
