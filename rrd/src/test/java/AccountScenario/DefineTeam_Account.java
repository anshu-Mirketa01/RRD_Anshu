...
/**
 * <p>
 * <b>QAT-RRD-Automate Define New Team for Account- Create New Team- Add New
 * Criteria</b>
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * 5. Select Record type - Account criteria and clicks on Next button.
 * </p>
 * <p>
 * 6.New Team:Account Criteria pop up appears .
 * </p>
 * <p>
 ...
 * 
 * <p>
 * 23.Clicks on save that rendering to the Team details page.
 * </p>
 * 
 * 
 * 
...
public class DefineTeam_Account {
	...
	public String Testdata_sheet_path = System.getProperty("user.dir") + File.separator + "AppData" + File.separator
			+ "AccountTeamsetupDemo.xlsx";

	@BeforeMethod
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/DefineTeamSetupforaccount.html");
		logger = report.startTest("Verify add  Define Team Setup for account ");
			...
			for (int rownum = 2; rownum <= RRDTeamrowCount; rownum++) {
				...
				try {
...

					{
						...
						teamobj.clickonrecordtypeAccount();
						logger.log(LogStatus.INFO, "Succesfully clicked on  RRD New team button");
						...
						/*
						 * teamobj.type_Allowed_Num_of_case(SAllowed_Numbe); logger.log(LogStatus.INFO,
						 * "Succesfully Enter Allowed Num of open case");
						 */
