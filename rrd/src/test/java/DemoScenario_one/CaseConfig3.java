package DemoScenario_one;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Case Configuration 13</b>
	 * </p>
	 * <p>
	 ...
	 * <p>7.Select owner notification from drop down value that is by None.</p>
	 ...
	 */
		...
		public class CaseConfig3 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration3.html");
				logger = report.startTest("Verify Case Configuration3");
			...
			@Test
			public void TestCaseConfig3() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig3");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig3", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig3", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig3", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig3", "casepriority", rowNum);
