package DemoScenario_one;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config32 {
			...
			public String Testdata_sheet_path=System.getProperty("user.dir") +File.separator+"AppData"+File.separator+"DemoScenarioOne.xlsx";

			SoftAssert softassert=new SoftAssert();
			
			@BeforeMethod
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation32.html");
			...
			@Test
			public void CaseCreation_config32() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config32");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config32", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config32", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config32", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config32", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config32", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config32", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config32", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config32", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config32", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config32", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config32", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config32", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config32", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config32", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config32", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config32", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config32", "ToBeAssigned", rowNum);
