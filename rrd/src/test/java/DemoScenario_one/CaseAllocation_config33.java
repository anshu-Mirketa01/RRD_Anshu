package DemoScenario_one;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config33 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation33.html");
			...
			@Test
			public void CaseCreation_config33() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config33");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config33", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config33", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config33", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config33", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config33", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config33", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config33", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config33", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config33", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config33", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config33", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config33", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config33", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config33", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config33", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config33", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config33", "ToBeAssigned", rowNum);
