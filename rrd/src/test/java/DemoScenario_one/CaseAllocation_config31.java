package DemoScenario_one;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config31 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation31.html");
			...
			@Test
			public void CaseCreation_config31() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config31");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config31", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config31", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config31", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config31", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config31", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config31", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config31", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config31", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config31", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config31", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config31", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config31", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config31", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config31", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config31", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config31", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config31", "ToBeAssigned", rowNum);
