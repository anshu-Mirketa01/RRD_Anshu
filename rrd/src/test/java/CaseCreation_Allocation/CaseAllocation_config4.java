package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config4 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation4.html");
				logger = report.startTest("Verify Case Creation4");
			...
			@Test
			public void CaseCreation_config4() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config4");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config4", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config4", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config4", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config4", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config4", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config4", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config4", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config4", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config4", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config4", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config4", "WebEmailtext", rowNum);
