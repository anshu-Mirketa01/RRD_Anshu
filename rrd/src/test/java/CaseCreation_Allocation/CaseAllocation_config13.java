package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config13 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation13.html");
				logger = report.startTest("Verify Case Creation13");
			...
			@Test
			public void CaseCreation_config13() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config13");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config13", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config13", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config13", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config13", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config13", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config13", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config13", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config13", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config13", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config13", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config13", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config13", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config13", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config13", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config13", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config13", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config13", "ToBeAssigned", rowNum);
