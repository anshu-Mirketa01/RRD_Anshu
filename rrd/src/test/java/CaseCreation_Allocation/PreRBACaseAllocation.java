package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class PreRBACaseAllocation {
			...
			@Test
			public void PreRBAcaseAllocation() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("PreRBACaseAllocation");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("PreRBACaseAllocation", "Status", rowNum);
					 String Priority=reader.getCellData("PreRBACaseAllocation", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("PreRBACaseAllocation", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("PreRBACaseAllocation", "Salutation", rowNum);
					 String firstname=reader.getCellData("PreRBACaseAllocation", "Firstname", rowNum);
					 String lastName=reader.getCellData("PreRBACaseAllocation", "LastName", rowNum);
					 String Account=reader.getCellData("PreRBACaseAllocation", "Account", rowNum);
					 String Ratingval=reader.getCellData("PreRBACaseAllocation", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("PreRBACaseAllocation", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("PreRBACaseAllocation", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("PreRBACaseAllocation", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("PreRBACaseAllocation", "Subject", rowNum);
				     String Description=reader.getCellData("PreRBACaseAllocation", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("PreRBACaseAllocation", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("PreRBACaseAllocation", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("PreRBACaseAllocation", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("PreRBACaseAllocation", "ToBeAssigned", rowNum);
