package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class preRbaCaseAllocationconfig7 {
			...
			@Test
			public void PreRBAcaseAllocation7() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("PreRbaCaseAllocation7");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("PreRbaCaseAllocation7", "Status", rowNum);
					 String Priority=reader.getCellData("PreRbaCaseAllocation7", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("PreRbaCaseAllocation7", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("PreRbaCaseAllocation7", "Salutation", rowNum);
					 String firstname=reader.getCellData("PreRbaCaseAllocation7", "Firstname", rowNum);
					 String lastName=reader.getCellData("PreRbaCaseAllocation7", "LastName", rowNum);
					 String Account=reader.getCellData("PreRbaCaseAllocation7", "Account", rowNum);
					 String Ratingval=reader.getCellData("PreRbaCaseAllocation7", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("PreRbaCaseAllocation7", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("PreRbaCaseAllocation7", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("PreRbaCaseAllocation7", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("PreRbaCaseAllocation7", "Subject", rowNum);
				     String Description=reader.getCellData("PreRbaCaseAllocation7", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("PreRbaCaseAllocation7", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("PreRbaCaseAllocation7", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("PreRbaCaseAllocation7", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("PreRbaCaseAllocation7", "ToBeAssigned", rowNum);
