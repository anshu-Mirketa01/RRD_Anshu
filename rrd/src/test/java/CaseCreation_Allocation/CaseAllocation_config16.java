package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config16 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation16.html");
				logger = report.startTest("Verify Case Creation16");
			...
			@Test
			public void CaseCreation_config16() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config16");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config16", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config16", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config16", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config16", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config16", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config16", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config16", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config16", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config16", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config16", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config16", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config16", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config16", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config16", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config16", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config16", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config16", "ToBeAssigned", rowNum);
