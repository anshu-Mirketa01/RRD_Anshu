...
import com.relevantcodes.extentreports.LogStatus;
	 ...
	 *
	 */
public class CaseAllocation_config1 {
		...
		public void CaseCreation_config1() throws InterruptedException
		{
			...
			int rowCount = reader.getRowCount("CaseAllocation_config1");
			for (int rowNum = 2; rowNum <= rowCount; rowNum++)
			{
			     String Status=reader.getCellData("CaseAllocation_config1", "Status", rowNum);
				 String Priority=reader.getCellData("CaseAllocation_config1", "Priority", rowNum);
				 String CaseOrigin=reader.getCellData("CaseAllocation_config1", "CaseOrigin", rowNum);
				 String  saluationtest=reader.getCellData("CaseAllocation_config1", "Salutation", rowNum);
				 String firstname=reader.getCellData("CaseAllocation_config1", "Firstname", rowNum);
				 String lastName=reader.getCellData("CaseAllocation_config1", "LastName", rowNum);
				 String Account=reader.getCellData("CaseAllocation_config1", "Account", rowNum);
				 String Ratingval=reader.getCellData("CaseAllocation_config1", "Ratingtype", rowNum);
				 String RRDType=reader.getCellData("CaseAllocation_config1", "RRDType", rowNum);
				 String RRDCaseReason=reader.getCellData("CaseAllocation_config1", "RRDCaseReason", rowNum);
			     String WebEmailtext=reader.getCellData("CaseAllocation_config1", "WebEmailtext", rowNum);
			     String Subject=reader.getCellData("CaseAllocation_config1", "Subject", rowNum);
			     String Description=reader.getCellData("CaseAllocation_config1", "Description", rowNum);
			     String Internalcommnet=reader.getCellData("CaseAllocation_config1", "Internal comment", rowNum);
			     String Assigneduser=reader.getCellData("CaseAllocation_config1", "ExpectedResult", rowNum);
			     String Teamname=reader.getCellData("CaseAllocation_config1", "TeamName", rowNum);
			     String ToBecount=reader.getCellData("CaseAllocation_config1", "ToBeAssigned", rowNum);
			...
			caseobj.scrolldowntosearchAcc();
			 ...
			 logger.log(LogStatus.INFO, "Successfully clicked on save");
				//scrolling
				/*
				 * caseobj.scrolldowntopicktype(); logger.log(LogStatus.INFO,
				 * "Scroll down to pick Type from drop down");
				 * 
