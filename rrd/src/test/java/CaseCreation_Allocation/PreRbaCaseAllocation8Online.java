package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class PreRbaCaseAllocation8Online {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/PreRBACaseAllocation.html");
				logger = report.startTest("Verify PreRBACaseAllocation");
			...
			@Test
			public void PreRBAcaseAllocation8() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("PreRbaCaseAllocation8");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("PreRbaCaseAllocation8", "Status", rowNum);
					 String Priority=reader.getCellData("PreRbaCaseAllocation8", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("PreRbaCaseAllocation8", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("PreRbaCaseAllocation8", "Salutation", rowNum);
					 String firstname=reader.getCellData("PreRbaCaseAllocation8", "Firstname", rowNum);
					 String lastName=reader.getCellData("PreRbaCaseAllocation8", "LastName", rowNum);
					 String Account=reader.getCellData("PreRbaCaseAllocation8", "Account", rowNum);
					 String Ratingval=reader.getCellData("PreRbaCaseAllocation8", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("PreRbaCaseAllocation8", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("PreRbaCaseAllocation8", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("PreRbaCaseAllocation8", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("PreRbaCaseAllocation8", "Subject", rowNum);
				     String Description=reader.getCellData("PreRbaCaseAllocation8", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("PreRbaCaseAllocation8", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("PreRbaCaseAllocation8", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("PreRbaCaseAllocation8", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("PreRbaCaseAllocation8", "ToBeAssigned", rowNum);
