package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config7 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation7.html");
				logger = report.startTest("Verify Case Creation7");
			...
			@Test
			public void CaseCreation_config7() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config7");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config7", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config7", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config7", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config7", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config7", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config7", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config7", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config7", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config7", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config7", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config7", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config7", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config7", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config7", "Internal comment", rowNum);
				   //  String Assigneduser=reader.getCellData("CaseAllocation_config7", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config7", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config7", "ToBeAssigned", rowNum);
				 ...
				 */
				 ...
				 reader.setCellData("CaseAllocation_config7", "ExpectedResult", rowNum,Username );
				 String Assigneduser=reader.getCellData("CaseAllocation_config7", "ExpectedResult", rowNum);
				 if(Assigneduser.contains("Integration User"))
				 {
				 softassert.assertTrue(Username.equalsIgnoreCase("RRD Mirketa"),"Assigned RRD user name is not matching");
				 }
				 else if(Assigneduser.contains("Security User"))
				 {
