package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config11 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation11.html");
				logger = report.startTest("Verify Case Creation11");
			...
			@Test
			public void CaseCreation_config11() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config11");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config11", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config11", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config11", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config11", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config11", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config11", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config11", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config11", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config11", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config11", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config11", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config11", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config11", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config11", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config11", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config11", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config11", "ToBeAssigned", rowNum);
