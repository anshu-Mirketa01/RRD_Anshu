package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config8 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation8.html");
				logger = report.startTest("Verify Case Creation8");
			...
			@Test
			public void CaseCreation_config8() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config8");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config8", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config8", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config8", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config8", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config8", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config8", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config8", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config8", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config8", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config8", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config8", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config8", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config8", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config8", "Internal comment", rowNum);
				    // String Assigneduser=reader.getCellData("CaseAllocation_config8", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config8", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config8", "ToBeAssigned", rowNum);
				 ...
				 */
				 ...
				 reader.setCellData("CaseAllocation_config8", "ExpectedResult", rowNum,Username );
				 String Assigneduser=reader.getCellData("CaseAllocation_config8", "ExpectedResult", rowNum);
