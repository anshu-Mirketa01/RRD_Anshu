...
import com.mirketa.pages.RRDSearchpage;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config5 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation5.html");
				logger = report.startTest("Verify Case Creation5");
			...
			@Test
			public void CaseCreation_config5() throws InterruptedException
			{
				...
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
					 ...
					 String Priority=reader.getCellData("CaseAllocation_config5", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config5", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config5", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config5", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config5", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config5", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config5", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config5", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config5", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config5", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config5", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config5", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config5", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config5", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config5", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config5", "ToBeAssigned", rowNum);
				      
				     
				ManualDistributionPage distribute = PageFactory.initElements(driver, ManualDistributionPage.class); 
				distribute.clickOnManualdistribution();
				logger.log(LogStatus.INFO, "Successfully clicked on manual distribution to check the count of case in queue");
