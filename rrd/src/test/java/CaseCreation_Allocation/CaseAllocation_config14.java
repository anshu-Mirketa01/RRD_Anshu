package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config14 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation14.html");
				logger = report.startTest("Verify Case Creation14");
			...
			@Test
			public void CaseCreation_config14() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config14");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config14", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config14", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config14", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config14", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config14", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config14", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config14", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config14", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config14", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config14", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config14", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config14", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config14", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config14", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config14", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config14", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config14", "ToBeAssigned", rowNum);
