package CaseCreation_Allocation;
	...
	public class CaseAllocation_config2 {
			...
			public void CaseCreation_config2() throws InterruptedException
			{
				...
				int rowCount = reader.getRowCount("CaseAllocation_config2");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config2", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config2", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config2", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config2", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config2", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config2", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config2", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config2", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config2", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config2", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config2", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config2", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config2", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config2", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config2", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config2", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config2", "ToBeAssigned", rowNum);
