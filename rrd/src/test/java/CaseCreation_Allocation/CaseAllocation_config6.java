package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config6 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation6.html");
				logger = report.startTest("Verify Case Creation6");
			...
			@Test
			public void CaseCreation_config6() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config6");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config6", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config6", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config6", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config6", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config6", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config6", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config6", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config6", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config6", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config6", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config6", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config6", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config6", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config6", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config6", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config6", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config6", "ToBeAssigned", rowNum);
