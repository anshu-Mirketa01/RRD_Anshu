...
import com.mirketa.pages.contactPage;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config10 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation10.html");
				logger = report.startTest("Verify Case Creation10");
			...
			@Test
			public void CaseCreation_config10() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config10");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config10", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config10", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config10", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config10", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config10", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config10", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config10", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config10", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config10", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config10", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config10", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config10", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config10", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config10", "Internal comment", rowNum);
