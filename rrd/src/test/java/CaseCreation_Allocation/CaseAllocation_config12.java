package CaseCreation_Allocation;
	...
	import com.relevantcodes.extentreports.LogStatus;
		 ...
		 *
		 */
	public class CaseAllocation_config12 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseCreation12.html");
				logger = report.startTest("Verify Case Creation12");
			...
			@Test
			public void CaseCreation_config12() throws InterruptedException
			{
				
				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("CaseAllocation_config12");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				     String Status=reader.getCellData("CaseAllocation_config12", "Status", rowNum);
					 String Priority=reader.getCellData("CaseAllocation_config12", "Priority", rowNum);
					 String CaseOrigin=reader.getCellData("CaseAllocation_config12", "CaseOrigin", rowNum);
					 String  saluationtest=reader.getCellData("CaseAllocation_config12", "Salutation", rowNum);
					 String firstname=reader.getCellData("CaseAllocation_config12", "Firstname", rowNum);
					 String lastName=reader.getCellData("CaseAllocation_config12", "LastName", rowNum);
					 String Account=reader.getCellData("CaseAllocation_config12", "Account", rowNum);
					 String Ratingval=reader.getCellData("CaseAllocation_config12", "Ratingtype", rowNum);
					 String RRDType=reader.getCellData("CaseAllocation_config12", "RRDType", rowNum);
					 String RRDCaseReason=reader.getCellData("CaseAllocation_config12", "RRDCaseReason", rowNum);
				     String WebEmailtext=reader.getCellData("CaseAllocation_config12", "WebEmailtext", rowNum);
				     String Subject=reader.getCellData("CaseAllocation_config12", "Subject", rowNum);
				     String Description=reader.getCellData("CaseAllocation_config12", "Description", rowNum);
				     String Internalcommnet=reader.getCellData("CaseAllocation_config12", "Internal comment", rowNum);
				     String Assigneduser=reader.getCellData("CaseAllocation_config12", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("CaseAllocation_config12", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("CaseAllocation_config12", "ToBeAssigned", rowNum);
