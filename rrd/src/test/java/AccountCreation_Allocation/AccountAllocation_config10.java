...
public class AccountAllocation_config10 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/AccountCreation10.html");
		logger = report.startTest("Verify Account Creation10");
	...
	@Test
	public void AccountCreation_config10() throws InterruptedException
	{
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
			 ...
			 String Rating=reader.getCellData("AccountAllocation10", "Rating", rowNum);
			 String Industryval=reader.getCellData("AccountAllocation10", "Industry", rowNum);
			 String Result=reader.getCellData("AccountAllocation10", "ExpectedResult", rowNum);
		     String Teamname=reader.getCellData("AccountAllocation10", "TeamName", rowNum);
		     String ToBecount=reader.getCellData("AccountAllocation10", "ToBeAssigned", rowNum);
