...
public class AccountAllocation_config3 {
	...
	SoftAssert softassert=new SoftAssert();
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/AccountCreation3.html");
				logger = report.startTest("Verify Account Creation3");
			...
			public void AccountCreation_config1() throws InterruptedException
			{
				...
				{
				     String AccountName=reader.getCellData("AccountAllocation3", "AccountName", rowNum);
					 String Rating=reader.getCellData("AccountAllocation3", "Rating", rowNum);
					 String act=reader.getCellData("AccountAllocation3", "Activity", rowNum);
					 String Result=reader.getCellData("AccountAllocation3", "ExpectedResult", rowNum);
				     String Teamname=reader.getCellData("AccountAllocation3", "TeamName", rowNum);
				     String ToBecount=reader.getCellData("AccountAllocation3", "ToBeAssigned", rowNum);
				 ...
				 logger.log(LogStatus.INFO, "scroll down to active");
				 
				 Accobj.clickonActivity();
				 logger.log(LogStatus.INFO, "click on Activity");
				 
				
				Accobj.PickActivefromlist(act);
				logger.log(LogStatus.INFO, "Picked  Activity from list"); 
