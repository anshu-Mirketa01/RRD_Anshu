...
public class AccountAllocation_config4 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/AccountCreation4.html");
		logger = report.startTest("Verify Account Creation4");
	...
	@Test
	public void AccountCreation_config4() throws InterruptedException
	{
		
		Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
		
		int rowCount = reader.getRowCount("AccountAllocation4");
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		     String AccountName=reader.getCellData("AccountAllocation4", "AccountName", rowNum);
			 String Rating=reader.getCellData("AccountAllocation4", "Rating", rowNum);
			 String Cus_priority=reader.getCellData("AccountAllocation4", "CustomerPriority", rowNum);
			 String Result=reader.getCellData("AccountAllocation4", "ExpectedResult", rowNum);
		     String Teamname=reader.getCellData("AccountAllocation4", "TeamName", rowNum);
		     String ToBecount=reader.getCellData("AccountAllocation4", "ToBeAssigned", rowNum);
		 ...
		 Accobj.scrolltoactive();
		 logger.log(LogStatus.INFO, "scroll to customer priority");
		 
		 Accobj.clickonCustomerprio();
		 logger.log(LogStatus.INFO, "Click on customer priority");
