...
public class AccountAllocation_config7 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/AccountCreation7.html");
		logger = report.startTest("Verify Account Creation7");
	...
	@Test
	public void AccountCreation_config7() throws InterruptedException
	{
	
		Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
		
		int rowCount = reader.getRowCount("AccountAllocation7");
		
		
		
		for (int rowNum = 2; rowNum <= rowCount; rowNum++)
		{
		     String AccountName=reader.getCellData("AccountAllocation7", "AccountName", rowNum);
			 String Rating=reader.getCellData("AccountAllocation7", "Rating", rowNum);
			 String SLAval=reader.getCellData("AccountAllocation7", "SLA", rowNum);
			 String Result=reader.getCellData("AccountAllocation7", "ExpectedResult", rowNum);
		     String Teamname=reader.getCellData("AccountAllocation7", "TeamName", rowNum);
		     String ToBecount=reader.getCellData("AccountAllocation7", "ToBeAssigned", rowNum);
