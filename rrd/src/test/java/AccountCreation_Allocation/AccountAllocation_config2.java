...
public class AccountAllocation_config2 
	
 {
	SoftAssert softassert=new SoftAssert();
		...
		public void AccountCreation_config1() throws InterruptedException
		{
			...
			int rowCount = reader.getRowCount("AccountAllocation2");
			for (int rowNum = 2; rowNum <= rowCount; rowNum++)
			{
			     String AccountName=reader.getCellData("AccountAllocation2", "AccountName", rowNum);
				 String Rating=reader.getCellData("AccountAllocation2", "Rating", rowNum);
				 String City=reader.getCellData("AccountAllocation2", "BillingCity", rowNum);
				 String Result=reader.getCellData("AccountAllocation2", "ExpectedResult", rowNum);
			     String Teamname=reader.getCellData("AccountAllocation2", "TeamName", rowNum);
			     String ToBecount=reader.getCellData("AccountAllocation2", "ToBeAssigned", rowNum);
