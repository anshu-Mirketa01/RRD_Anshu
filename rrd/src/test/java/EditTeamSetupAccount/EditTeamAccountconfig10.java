...
public class EditTeamAccountconfig10 {
	WebDriver driver;
	...
	public void EditTeamsetup() throws InterruptedException{
		...
		int RRDEditCount = reader.getRowCount("Accountconfig10");
		
		
		String SteamName = reader.getCellData("Accountconfig10", "TeamName", RRDEditCount);
		String Accountconfig= reader.getCellData("Accountconfig10", "AccountConfig", RRDEditCount);
		String EditMaxinlimit=reader.getCellData("Accountconfig10", "EditMaxIntakeLimit" , RRDEditCount);
		String teamopencaset=reader.getCellData("Accountconfig10", "EditTeamopencase", RRDEditCount);
		String EditRecordlimit=reader.getCellData("Accountconfig10", "EditRecordAssignlimit", RRDEditCount);
		String Edituseropencases=reader.getCellData("Accountconfig10", "EditAllowOpencases", RRDEditCount);
