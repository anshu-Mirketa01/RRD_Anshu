...
public class EditTeamAccountconfig9 {
	...
	public void EditTeamsetup() throws InterruptedException{
		...
		int RRDEditCount = reader.getRowCount("Accountconfig9");
		
		
		String SteamName = reader.getCellData("Accountconfig9", "TeamName", RRDEditCount);
		String Accountconfig= reader.getCellData("Accountconfig9", "AccountConfig", RRDEditCount);
		String EditMaxinlimit=reader.getCellData("Accountconfig9", "EditMaxIntakeLimit" , RRDEditCount);
		String teamopencaset=reader.getCellData("Accountconfig9", "EditTeamopencase", RRDEditCount);
		String EditRecordlimit=reader.getCellData("Accountconfig9", "EditRecordAssignlimit", RRDEditCount);
		String Edituseropencases=reader.getCellData("Accountconfig9", "EditAllowOpencases", RRDEditCount);
