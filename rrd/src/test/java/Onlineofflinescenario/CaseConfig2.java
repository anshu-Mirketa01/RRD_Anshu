package Onlineofflinescenario;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Case Configuration 2</b>
	 * </p>
	 * <p>
	 ...
	 */
		...
		public class CaseConfig2 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration2.html");
				logger = report.startTest("Verify Case Configuration2");
			...
			@Test
			public void TestCaseConfig2() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig2");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig2", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig2", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig2", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig2", "casepriority", rowNum);
