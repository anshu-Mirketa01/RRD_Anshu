package Onlineofflinescenario;
	...
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Case Configuration 4</b>
	 * </p>
	 * <p>
	 ...
	 */
		...
		public class CaseConfig4 {
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/CaseConfiguration4.html");
				logger = report.startTest("Verify Case Configuration4");
			...
			@Test
			public void TestCaseConfig4() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Caseconfig4");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Caseconfig4", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Caseconfig4", "ownerNotification", rowNum);
				String sReleationshipBasedAssignment=reader.getCellData("Caseconfig4", "Rel_Based_Asgmt", rowNum);
				String sCasePriority=reader.getCellData("Caseconfig4", "casepriority", rowNum);
