...
public class AccountConfig8 {
	
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Account Configuration 8</b>
	 * </p>
	 * <p>
	 ...
	 * <p>7.Select owner notification from drop down value that is byBoth.</p>
	 ...
	 */
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/AccountConfiguration8.html");
				logger = report.startTest("Verify Account Configuration8");
			...
			@Test
			public void TestAccountConfig8() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Accountconfig8");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Accountconfig8", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Accountconfig8", "ownerNotification", rowNum);
				String sDefaultowner=reader.getCellData("Accountconfig8", "DefaultOwner", rowNum);
