...
public class AccountConfig7 {
	
	/**
	 * <p>
	 * <b>QAT-RRD-Automate Account Configuration 7</b>
	 * </p>
	 * <p>
	 ...
	 */
			...
			public void setUp() throws FileNotFoundException, InterruptedException {
				report = new ExtentReports("./Report/AccountConfiguration7.html");
				logger = report.startTest("Verify Account Configuration7");
			...
			@Test
			public void TestAccountConfig7() throws InterruptedException{

				Xls_Reader reader = new Xls_Reader(Testdata_sheet_path);
				
				int rowCount = reader.getRowCount("Accountconfig7");
				for (int rowNum = 2; rowNum <= rowCount; rowNum++)
				{
				
				String sUser1=reader.getCellData("Accountconfig7", "Enable_RRD_Users" , rowNum);
				String sOwnerNotification=reader.getCellData("Accountconfig7", "ownerNotification", rowNum);
				String sDefaultowner=reader.getCellData("Accountconfig7", "DefaultOwner", rowNum);
