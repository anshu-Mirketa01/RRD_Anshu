...
public class CaseManualDistribution9 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/CaseDistribution9.html");
		logger = report.startTest("Verify Case Distribution9");
	...
	public void CaseManualDistribution9() throws InterruptedException {
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			...
			String Assigneduser = reader.getCellData("CaseAllocation_config9", "ExpectedResultAfterDistribution", rowNum);
			String Teamname = reader.getCellData("CaseAllocation_config9", "TeamName", rowNum);
			String ToBecount = reader.getCellData("CaseAllocation_config9", "ToBeAssignedAfterdistribution", rowNum);
			String caseid = reader.getCellData("CaseAllocation_config9", "CaseNo", rowNum);
		...
		reader.removeColumn("CaseAllocation_config9", 20);
		Thread.sleep(3000);
