...
public class CaseManualDistribution17 {
	...
	public void setUp() throws FileNotFoundException, InterruptedException {
		report = new ExtentReports("./Report/CaseDistribution17.html");
		logger = report.startTest("Verify Case Distribution17");
	...
	public void CaseManualDistribution9() throws InterruptedException {
		...
		for (int rowNum = 2; rowNum <= rowCount; rowNum++) {
			...
			String Assigneduser = reader.getCellData("CaseAllocation_config17", "ExpectedResultAfterDistribution", rowNum);
			String Teamname = reader.getCellData("CaseAllocation_config17", "TeamName", rowNum);
			String ToBecount = reader.getCellData("CaseAllocation_config17", "ToBeAssignedAfterdistribution", rowNum);
			String caseid = reader.getCellData("CaseAllocation_config17", "CaseNo", rowNum);
		...
		reader.removeColumn("CaseAllocation_config17", 20);
		Thread.sleep(3000);
