...
public class Step1ConfigurationPage {
	...
	@FindBy(xpath = "//td[@class='dataCol last']//input[starts-with(@id,'j_id0:theForm:thePageBlockOne:j_id') and @type='checkbox']")
	...
	public void navigatetoIframeCaseConfig() throws InterruptedException {
