...
WebDriver driver;
	...
	@FindBy(xpath="(//table/tbody/tr//td//select[starts-with(@name,'j_id0:frm:pb:pbs:j_id')])[1]")
	WebElement SelectField;
	
	@FindBy(xpath="(//table/tbody/tr//td//select[starts-with(@name,'j_id0:frm:pb:pbs:j_id')])[2]")
