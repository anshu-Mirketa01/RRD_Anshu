...
public class Step1AccountConfigurationpage {
	WebDriver driver;

	public Step1AccountConfigurationpage(WebDriver ldriver) {
		this.driver = ldriver;
	}
	...
	@FindBy(xpath="//tr//td[@class='rich-tabhdr-side-cell']//td[contains(text(),'Account')]")
	...
	@FindBy(xpath = "(//select[starts-with(@name,'j_id0:theForm:thePageBlockOne:hidepgaeblocksectionAccount:j_id')])[1]")
	WebElement EnableRRD;
	
	
	@FindBy(xpath = "(//select[starts-with(@name,'j_id0:theForm:thePageBlockOne:hidepgaeblocksectionAccount:j_id')])[2]")
	WebElement OwnerNotification;

	@FindBy(xpath = "//select[starts-with(@name,'j_id0:theForm:thePageBlockOne:showpgaeblocksectionAccNotification:j_id')]")
	...
	public void clickOnAccount() throws InterruptedException {
		SyncElement.TobeClickable(driver, clickonAccount, 30);
		clickonAccount.click();
		Thread.sleep(5000);
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	}
	
	public void navigatetoIframeAccountConfig() throws InterruptedException {
