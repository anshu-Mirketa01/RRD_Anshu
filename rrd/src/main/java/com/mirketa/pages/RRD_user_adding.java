...
public class RRD_user_adding {
	public WebDriver driver;
		...
		*/
		...
		//@FindBy(xpath="(//span[contains(text(),'Allowed Number of Open Cases')]//following::input[@class='input uiInputSmartNumber'])[2]")
	...
	/*	public void click_on_more()
		...
		*/
		...
		public void clicksOnsearchPeople(String typeuser) throws InterruptedException
		{
		    SyncElement.isElementPresnt(driver, Related, 30);
			RRDusersearch.click();
			driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			Thread.sleep(1500);
			RRDusersearch.sendKeys(typeuser);
			Thread.sleep(1500);
